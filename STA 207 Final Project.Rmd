...
- \(\mu\) is the mean math score when all other predictor variables are set to their reference levels.
...
I worked with Jingzhi Sun and Zichen Hu on this project. In particular, code for the Sankey plot used in [Noncompliance: Were Students Allowed to Switch Classes? Are there Trends Among Students who Switched Class Sizes?] was strictly developed by Jingzhi.
